...
public class Demo_035_Operators_Logical {
	...
	public static void main(String[] args) {
		...
		// if any condition is failed then run time environment will not check
		...
		// always check the object null , before we retrieve any value from
		// object and make sure && operator is used .
		...
		// if any condition is true then run time environment will not check
		// rest of the conditions
		a = 1;
		b = 0;
		c = 1;
